...
const Signup = () => {
  ...
  async function getUser() {
    const config = {
      method: 'get',
      url: 'http://localhost:8000/getRoles.php'
    }
    ...
    <>
      ...
      <div className="register-div">
        <div className="register-box">
          ...
          <form name="signup" action="#" onSubmit={validateForm} style={{display: "block"}}>
          ...
          <div className="pad-top warning-text" id="manager-warning">
            Note: If you are applying for "School Admin" Role, you'll have to wait for
