...
const ManageBusinessAdvertisements = () => {
  useEffect(() => {
    getPosts();
    }, [])
  ...
  async function getPosts() {
      const config = {
        method: 'get',
        url: 'http://localhost:8000/getAdvertisements.php'
      }
...
<div className="mb-main-div">
  <div className="main-title">Manage Advertisements</div>
  <div className="mb-content-div">
    <div className="mb-sub-content">
      <div>
        <div className="sub-title">New Advertisement</div>
      ...
      <div className="mb-content-div">
        <div className="mb-single-option">
          <div className="delete-advertisement">
            <div className="mb-sub-content">
              <div>
                <div className="sub-title">Delete an Advertisement</div>
                ...
                <table className="styled-table" id="adv-table">
                  ...
                  {PostsList.length > 0 ? PostsList.map((i,index)=>
                      <tr key={index}>
                        ...
                        <td> <button type="buy" className="mma-buy-btn" onClick={() => delPostsForm(i.advId,i.AdvTitle)} >Delete Post</button>
                          </td>
...
export default ManageBusinessAdvertisements;