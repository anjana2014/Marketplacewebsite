...
const ManageBusinessOwner = () => {
  ...
  async function getManagerDetails() {
    const config = {
      method: 'get',
      url: 'http://localhost:8000/managebusinessOwners.php'
    }
  ...
  function approveManagerRequest(email) {
    axios({
      method: 'post',
      url: "http://localhost:8000/approvebusinessOwnerRequest.php",
      headers: {
    ...
    currentRole === "Admin" || currentRole === "SchoolAdmin"?
      <>
        ...
        <div className="main-div">
          <div className="main-title">Manage BusinessOwner</div>
          <div className="mma-content">
            <div>
              <div style={{ textAlign: "left" }}>BusinessOwner Role Requests</div>
            ...
            <div className="pad-top-2">
              <div style={{ textAlign: "left" }}>Active BusinessOwners</div>
              <div className="table-div">
                <table className="styled-table" id="active-manager-table">
                  ...
                  <tbody>
                    ...
                    ) : <tr><td colSpan={4}> There are no active BusinessOwners</td></tr>}
                  </tbody>
                </table>
              </div>
            </div>
            <div className="pad-top-2">
              <div style={{ textAlign: "left" }}>Inactive BusinessOwners</div>
              <div className="table-div">
                <table className="styled-table" id="inactive-manager-table">
                  ...
                  <tbody>
                    ...
                    ) : <tr><td colSpan={4}> There are no in active BusinessOwners</td></tr>}
                  </tbody>
                </table>
              </div>
            </div>
