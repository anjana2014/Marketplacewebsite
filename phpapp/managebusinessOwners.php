...
$query1 = "SELECT * FROM user_details where role='BusinessOwner' and isActive = 2";
$query2 = "SELECT * FROM user_details where role='BusinessOwner' and isActive = 1";
$query3 = "SELECT * FROM user_details where role='BusinessOwner' and isActive = 0";
